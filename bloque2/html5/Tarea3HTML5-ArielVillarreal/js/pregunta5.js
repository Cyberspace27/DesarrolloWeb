...
function respuesta(number) {
	...
	if(contador == 0){
        ...
        document.getElementById("resultado").classList.add("correcto");
         ...
         var text = document.createTextNode("Reiniciar el Juego");
        document.getElementById("reiniciar").appendChild(text);
        ...
        var text = document.createTextNode("Re Intentar");
        document.getElementById("newTry").appendChild(text);
    }
